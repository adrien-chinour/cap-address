...
class Mail implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['s_mail'] = isset($data['s_mail']) ? $data['s_mail'] : null;
    }
    ...
    {
        return $this->container['s_mail'];
    }

    /**
     * Sets s_mail
     *
     * @param string $s_mail s_mail
     *
     * @return $this
     */
    public function setSMail($s_mail)
    {
        $this->container['s_mail'] = $s_mail;
